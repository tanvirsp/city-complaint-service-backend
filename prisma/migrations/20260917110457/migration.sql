/*
  ...
  - The values [ONGING,COMPLETE] on the enum `ComplaintStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ComplaintStatus_new" AS ENUM ('PENDING', 'ASSIGNED', 'IN_PROGRESS', 'RESOLVED', 'REJECTED');
...
-- AlterTable
ALTER TABLE "complaints" ALTER COLUMN "staffId" DROP NOT NULL;
